...
- `[VH]` Validate Hierarchy (Process compliance)
- `[JE]` JIRA Export (Tooling)

### Dimension 2: Assets Management
- `[AM]` Assets Monetization
- Rachel: `[PM]` Pricing Model
- Rachel: `[PK]` Packaging Strategy
...
- `[CI]` Create Initiative (Discovery)
- `[CP]` Create Package (Planning)
- `[CE]` Create Epic (Development)
- Lisa: `[CJ]` Customer Journey (Full lifecycle)

### Dimension 6: Product Culture
- `[PC]` Product Culture & Training
- Onboarding materials
- Career path documents

### Dimension 7: Adeo Product Grade
- `[PG]` Product Grade Assessment
- Maturity evaluation frameworks
